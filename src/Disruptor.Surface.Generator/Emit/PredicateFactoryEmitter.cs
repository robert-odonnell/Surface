...
internal static class PredicateFactoryEmitter
{
    ...
    public static void Emit(SourceProductionContext spc, TableModel table)
    {
        ...
        sb.Append(indent).Append(EmitterAccessibility.FormatRoslyn(table.DeclaredAccessibility)).Append(" static class ").AppendLine(qTypeName);
        ...
        for (var i = 0; i < members.Count; i++)
        {
            ...
            sb.Append(memberIndent)
              .Append(EmitterAccessibility.FormatRoslyn(declaredAccessibility)).Append(" static readonly ")
