namespace Surface.Generator.Annotations;

/// <summary>
/// Fully-qualified metadata names the generator pipelines bind to. Kept in a single
/// place so the emitted source and the <c>ForAttributeWithMetadataName</c> pipeline
/// always agree.
/// </summary>
internal static class AnnotationsMetadata
{
    public const string Namespace = "Surface.Annotations";
...
/// <summary>
/// The literal source text that is injected into every compilation that references the
/// generator via <see cref="Microsoft.CodeAnalysis.IncrementalGeneratorInitializationContext.RegisterPostInitializationOutput"/>.
/// </summary>
internal static class AnnotationsSource
{
    public const string HintName = "Surface.Annotations.g.cs";
