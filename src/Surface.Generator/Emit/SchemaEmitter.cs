...
internal static class SchemaEmitter
{
    ...
    public static void Emit(SourceProductionContext spc, ModelGraph graph)
    {
        ...
        sb.Append(memberIndent).AppendLine("public static System.Collections.Generic.IReadOnlyList<string> Schema => SurfaceSchema._chunks;");
        sb.AppendLine();
        ...
        sb.Append(memberIndent).AppendLine("public static async global::System.Threading.Tasks.Task ApplySchemaAsync(global::Surface.Runtime.ISurrealTransport transport, global::System.Threading.CancellationToken ct = default)");
        ...
        sb.Append(indent).AppendLine("internal static class SurfaceSchema");
        sb.Append(indent).AppendLine("{");
        sb.Append(memberIndent).AppendLine("internal static readonly string[] _chunks = new[]");
        sb.Append(memberIndent).AppendLine("{");
        sb.Append(memberIndent).AppendLine("    global::Surface.Runtime.WriterLease.SchemaScript,");
