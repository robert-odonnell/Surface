...
internal static class GeneratorHarness
{
    ...
    private static IReadOnlyList<MetadataReference> ReferenceAssemblies()
    {
        ...
        // Runtime assemblies the source we compile depends on. AppDomain hosts Surface.Runtime
        ...
        // Surface.Runtime
        refs.Add(MetadataReference.CreateFromFile(typeof(Surface.Runtime.SurrealSession).Assembly.Location));
        // Ulid (transitive dep of Surface.Runtime)
